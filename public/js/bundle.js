...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(name, email, role, password, confirmPassword) {
    var res;
...
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"like.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateStatus = exports.likeSong = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert.js");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var likeCount = document.querySelector('.like__count');
var likeBtn = document.querySelector('.song__like--button');
var updateStatus = exports.updateStatus = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var songId, response, isLiked;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          songId = document.querySelector('.song__container--big').getAttribute('id');
          _context.next = 4;
          return _axios.default.get("/api/v1/songs/isSongLiked/".concat(songId));
        case 4:
          response = _context.sent;
          isLiked = response.data.like;
          likeBtn.innerHTML = "<img style=\"margin-left:4px\" src=\"/img/static/".concat(isLiked ? 'like-filled' : 'like', ".svg\" alt=\"like\" height=\"18px\">");
          return _context.abrupt("return", isLiked);
        case 10:
          _context.prev = 10;
          _context.t0 = _context["catch"](0);
          (0, _alert.showAlert)("error", _context.t0.response.data.message);
...
var likeSong = exports.likeSong = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var songId, response, isLiked;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          songId = document.querySelector('.song__container--big').getAttribute('id');
          _context2.next = 4;
          return _axios.default.patch("/api/v1/songs/".concat(songId, "/like"));
        case 4:
          response = _context2.sent;
          _context2.next = 7;
          return updateStatus(likeBtn);
        case 7:
          isLiked = _context2.sent;
          if (isLiked) {
  ...
  return function likeSong() {
    return _ref2.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"../../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
exports.submitPlaylistModel = exports.removeSong = exports.deletePlaylist = exports.closePlaylistModal = exports.addSong = exports.addPlaylist = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert.js");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var addSong = exports.addSong = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(playlistId, songId) {
    var response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "/api/v1/playlists/".concat(playlistId, "/updateSongs"),
            data: {
              song: songId
            }
          });
...
var removeSong = exports.removeSong = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(playlistId, songId) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
  ...
  return function removeSong(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var addPlaylist = exports.addPlaylist = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(name) {
    var response, playlistId;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
        ...
        case 3:
          ...
          return _context3.abrupt("return", playlistId);
        case 8:
          _context3.prev = 8;
          _context3.t0 = _context3["catch"](0);
  ...
  return function addPlaylist(_x5) {
    return _ref3.apply(this, arguments);
  };
}();
var closePlaylistModal = exports.closePlaylistModal = function closePlaylistModal() {
  document.getElementById('myModal').style.display = 'none';
};
var submitPlaylistModel = exports.submitPlaylistModel = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
    var songId, checkboxes, uncheckboxes, inputText, playlistId;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          checkboxes = _toConsumableArray(document.querySelectorAll('input[type="checkbox"]:checked')).map(function (el) {
            return el.value;
          });
          uncheckboxes = _toConsumableArray(document.querySelectorAll('input[type="checkbox"]:not(:checked)')).map(function (el) {
            return el.value;
          });
          _context4.next = 8;
          return checkboxes.forEach(function (el) {
            addSong(el, songId);
            // Add songs to all these playlists
          });
        case 8:
          _context4.next = 10;
          return uncheckboxes.forEach(function (el) {
            // Remove songs from all these playlists
            removeSong(el, songId);
          });
        case 10:
          // Get the input text given by user
          inputText = document.getElementById('newPlaylist').value;
          if (!(inputText !== '')) {
            _context4.next = 17;
            break;
          }
          _context4.next = 14;
          return addPlaylist(inputText);
        case 14:
          playlistId = _context4.sent;
          _context4.next = 17;
          return addSong(playlistId, songId);
        case 17:
          (0, _alert.showAlert)('success', 'Updated playlist(s)');
          closePlaylistModal();
          _context4.next = 24;
          break;
        case 21:
  ...
  return function submitPlaylistModel(_x6) {
...
var deletePlaylist = exports.deletePlaylist = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          playlistId = document.querySelector('.song__card').getAttribute('id');
          _context5.next = 3;
          return (0, _axios.default)({
            method: 'DELETE',
            url: "/api/v1/playlists/".concat(playlistId)
          });
        case 3:
          op = _context5.sent;
          if (op.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Playlist deleted successfully');
            window.location.href = '/playlists';
          } else {
            (0, _alert.showAlert)('error', 'Error deleting playlist');
          }
        case 5:
        case "end":
  ...
  return function deletePlaylist() {
...
var _like = require("./like.js");
require("regenerator-runtime/runtime.js");
var _playlist = require("./playlist.js");
console.log('Hello from the client side');
var loginForm = document.querySelector('.login-form > .form');
var logoutBtn = document.querySelector('.nav__element--logout');
var signupForm = document.querySelector('.signup-form > .form');
var likeBtn = document.querySelector('.song__like--button');
var searchBtn = document.querySelector('.searchbox__button');
var searchInput = document.querySelector('.searchbox__input');
var closeModal = document.querySelector('#myModal .close');
var modalForm = document.getElementById('modalForm');
var playlistBtn = document.querySelector('.song__card--playlist');
var audioElement = document.querySelector('#playerInPlaylist');
var playlistDelete = document.querySelector('#delete__icon');
likeBtn && (0, _like.updateStatus)(likeBtn);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "39835" + '/');
